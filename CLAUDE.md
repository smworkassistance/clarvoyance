...
| PWA | sw.js (cache version clv-v165), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v165**
...
*Last updated: 2026-08-01 — v165 saved. index.html = v165. Always copy new version to index.html after pushing.*
