...
*Last updated: 2026-08-08 — v181: daily ritual jhatka now capped to once/day (was showing every reload); reload restores the last-active tab instead of always snapping to Clar AI (chat still shows first for zero-flash, then switches once data loads). index.html copied to v181. Always copy new version to index.html after pushing.*
