...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v177**
...
*Last updated: 2026-08-04 — admin write-lockdown worker deployed and verified live (see "—" row above), index.html unchanged at v177. Always copy new version to index.html after pushing.*
