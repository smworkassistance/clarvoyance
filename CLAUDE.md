...
| PWA | sw.js (cache version clv-v163), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v163**
...
*Last updated: 2026-07-31 — v163 saved. index.html = v163. Always copy new version to index.html after pushing.*
