...
| PWA | sw.js (cache version clv-v150), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v150**
...
*Last updated: 2026-07-05 — v150 saved. index.html = v150. Always copy new version to index.html after pushing.*
