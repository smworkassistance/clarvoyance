...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v179**
...
*Last updated: 2026-08-04 — v179: momentum decay + Fortuneteller + Pulse switched from Clar-chat-only time to total app time (`clv_app_times`); chat header keeps its own chat-time display + new "10 min recommended today" nudge. index.html copied to v179. Always copy new version to index.html after pushing.*
