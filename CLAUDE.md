...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v182**
...
*Last updated: 2026-08-12 — v182 saved (feature-gated AI usage limits + admin Limits tab). index.html = v182. Requires db/schema_v182_feature_gates.sql to be run before it activates. Always copy new version to index.html after pushing.*
