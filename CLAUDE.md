...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v174**
...
*Last updated: 2026-08-02 — v174 saved. index.html = v174. Always copy new version to index.html after pushing.*
