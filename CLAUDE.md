...
| PWA | sw.js (cache version clv-v164), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v164**
...
*Last updated: 2026-07-31 — v164 saved. index.html = v164. Always copy new version to index.html after pushing.*
