...
| PWA | sw.js (cache version clv-v170), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v170**
...
*Last updated: 2026-08-01 — v170 saved. index.html = v170. Always copy new version to index.html after pushing.*
