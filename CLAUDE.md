...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v180**
...
*Last updated: 2026-08-05 — v180: Practice Plans — Clar can suggest a short, rare, time-boxed practice (new `user_practice_plans` table), tracked from existing logs, shown on Home as qualitative progress (no raw %). index.html copied to v180. Always copy new version to index.html after pushing.*
