...
| PWA | sw.js (cache version clv-v153), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v153**
...
*Last updated: 2026-07-11 — v153 saved. index.html = v153. Always copy new version to index.html after pushing.*
