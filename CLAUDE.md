...
| PWA | sw.js (cache version clv-v173), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v173**
...
*Last updated: 2026-08-01 — v173 saved. index.html = v173. Always copy new version to index.html after pushing.*
