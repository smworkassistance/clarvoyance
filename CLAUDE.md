...
| PWA | sw.js (cache version clv-v162), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v162**
...
*Last updated: 2026-07-31 — v162 saved. index.html = v162. Always copy new version to index.html after pushing.*
