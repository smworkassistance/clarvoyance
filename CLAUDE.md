...
| PWA | sw.js (cache version clv-v167), manifest.json, beforeinstallprompt — **bump CACHE_VERSION on every release** |
...
```
- `index.html` = always the latest pushed stable/testing version (what users see on GitHub Pages) — currently **v167**
...
*Last updated: 2026-08-01 — v167 saved. index.html = v167. Always copy new version to index.html after pushing.*
