...
globalThis.fetch = async (url, init) => {
  ...
  if (url.startsWith('https://clar-youtube.smworkassistance.workers.dev/')) { DB.calls.yt++; return DB.mode.ytFail ? json({}, 500) : json({ videos: [{ video_id: 'dQw4w9WgXcQ', title: 'A useful video' }] }); }
